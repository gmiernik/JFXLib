 ...
 * @author Miernik
 */
public abstract class MVPApplication<S extends Service> extends Application implements EventListener<SimpleActionEvent> {
    ...
    protected <P extends AbstractPresenter<S>> P load(String fxmlName, boolean bundle) {
        if (bundle) {
    ...
    /**
     *
     * @param <S> type of Presenter
     * @param fxmlFile name of FXML file
     * @param bundle resource bundle including texts
     * @return
     */
    @SuppressWarnings("unchecked")
	protected <P extends AbstractPresenter<S>> P load(String fxmlName, ResourceBundle bundle) {
        P presenter = null;
        try {
